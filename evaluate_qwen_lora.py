...
def main():
    ...
    parser.add_argument('--model_name', type=str, default="qwen2_5vl-7b",
                        help='model name')
    parser.add_argument('--prompt_type', type=str, default="multi_instruction",
                        help='model name')
    parser.add_argument('--model_path_root', type=str, default="/home/nperi/Workspace/LLaMA-Factory/saves",
                    help='model name')
    ...
    run_name = args.model_name+"_"+args.prompt_type+"_"+eval_mode_str
    ...
    for dataset_dir in tqdm(all_dataset_dirs, desc="Processing datasets", unit="dataset"):
        ...
        model_path = args.model_path_root + "/" + args.model_name + "/" + dataset_name + "/" + args.prompt_type
